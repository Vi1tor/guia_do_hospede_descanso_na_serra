        ...
        {highlightCategories.map((category, index) => {
          ...
          return (
            <motion.button
              ...
              onClick={() => onSelectCategory(category.id)}
              className="group flex items-center gap-4 bg-primary-900 p-5 rounded-xl shadow-md text-left hover:bg-primary-800 hover:shadow-lg transition-all active:scale-[0.98] w-full mt-4"
            >
              <div className="w-14 h-14 flex-shrink-0 bg-white/10 rounded-full flex items-center justify-center text-white">
